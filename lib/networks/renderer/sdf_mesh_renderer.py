...
class Renderer:
    ...
    def render(self, batch):
        ...
        covs = torch.zeros_like(pts)
        resd = self.batchify_residual_deformation(pts[None], batch, covs[None])[0]
        pts = pts + resd
